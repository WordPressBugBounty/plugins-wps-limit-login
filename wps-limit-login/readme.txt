...
= 1.5.9.4 =
* Fix vulnerability (Thanks Ananda Dhakal - Patchstack) : Vulnérabilité XSS stockée non authentifiée via un nom d'utilisateur ayant échoué à la connexion dans le journal de verrouillage.
